...
public class ZipAndSendMail
{
	...
	static String[] toEmails = { "swapnilgoud@gmail.com","swapnil.goud@yahoo.com" };
	static String fromUser = "swapnilgoud";//just the id alone without @gmail.com
	static String password = "sunny135";
